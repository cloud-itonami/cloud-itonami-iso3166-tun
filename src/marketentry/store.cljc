(ns marketentry.store
  "SSoT for the TUN market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems TN" :portal "TUNEPS/HAICOP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tn-entity? true :has-tn-entity? true
             :requires-rne? true :rne-verified? true
             :drafted? false :submitted? false
             :jurisdiction "TUN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "TUNEPS/HAICOP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tn-entity? true :has-tn-entity? true
             :requires-rne? true :rne-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "TUNEPS/HAICOP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "TUN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "TUNEPS/HAICOP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tn-entity? true :has-tn-entity? false
             :requires-rne? true :rne-verified? true
             :drafted? false :submitted? false
             :jurisdiction "TUN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "TUNEPS/HAICOP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tn-entity? true :has-tn-entity? true
             :requires-rne? true :rne-verified? false
             :drafted? false :submitted? false
             :jurisdiction "TUN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "TUNEPS/HAICOP"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-tn-entity? has-tn-entity?
                               requires-rne? rne-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-tn-entity?)  (assoc :engagement/requires-tn-entity? requires-tn-entity?)
    (some? has-tn-entity?)       (assoc :engagement/has-tn-entity? has-tn-entity?)
    (some? requires-rne?)    (assoc :engagement/requires-rne? requires-rne?)
    (some? rne-verified?)    (assoc :engagement/rne-verified? rne-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-tn-entity? :engagement/has-tn-entity?
   :engagement/requires-rne? :engagement/rne-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-tn-entity? (boolean (:engagement/requires-tn-entity? m))
     :has-tn-entity? (boolean (:engagement/has-tn-entity? m))
     :requires-rne? (boolean (:engagement/requires-rne? m))
     :rne-verified? (boolean (:engagement/rne-verified? m))
